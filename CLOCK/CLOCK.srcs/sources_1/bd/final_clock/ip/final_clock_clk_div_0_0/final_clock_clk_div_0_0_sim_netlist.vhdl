...
-- Command     : write_vhdl -force -mode funcsim -rename_top final_clock_clk_div_0_0 -prefix
--               final_clock_clk_div_0_0_ final_clock_clk_div_2_0_sim_netlist.vhdl
...
entity final_clock_clk_div_0_0_clk_div is
  port (
    clk_out : out STD_LOGIC;
    clk_in : in STD_LOGIC
  );
end final_clock_clk_div_0_0_clk_div;

architecture STRUCTURE of final_clock_clk_div_0_0_clk_div is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity final_clock_clk_div_0_0 is
  port (
    clk_in : in STD_LOGIC;
    clk_out : out STD_LOGIC
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of final_clock_clk_div_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of final_clock_clk_div_0_0 : entity is "final_clock_clk_div_2_0,clk_div,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of final_clock_clk_div_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of final_clock_clk_div_0_0 : entity is "clk_div,Vivado 2017.2";
end final_clock_clk_div_0_0;

architecture STRUCTURE of final_clock_clk_div_0_0 is
begin
inst: entity work.final_clock_clk_div_0_0_clk_div
     port map (
      clk_in => clk_in,
      clk_out => clk_out
    );
