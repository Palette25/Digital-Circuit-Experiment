...
-- Date        : Fri Dec 15 12:33:24 2017
-- Host        : LAPTOP-BBTT6KDL running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               E:/VivadoProjects/CLOCK/CLOCK.srcs/sources_1/bd/final_clock/ip/final_clock_clk_div_1_0/final_clock_clk_div_1_0_sim_netlist.vhdl
-- Design      : final_clock_clk_div_1_0
...
entity final_clock_clk_div_1_0_clk_div is
  port (
    clk_out : out STD_LOGIC;
    clk_in : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of final_clock_clk_div_1_0_clk_div : entity is "clk_div";
end final_clock_clk_div_1_0_clk_div;

architecture STRUCTURE of final_clock_clk_div_1_0_clk_div is
...
clk_out_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"07"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity final_clock_clk_div_1_0 is
  port (
    clk_in : in STD_LOGIC;
    clk_out : out STD_LOGIC
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of final_clock_clk_div_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of final_clock_clk_div_1_0 : entity is "final_clock_clk_div_1_0,clk_div,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of final_clock_clk_div_1_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of final_clock_clk_div_1_0 : entity is "clk_div,Vivado 2017.2";
end final_clock_clk_div_1_0;

architecture STRUCTURE of final_clock_clk_div_1_0 is
begin
inst: entity work.final_clock_clk_div_1_0_clk_div
     port map (
      clk_in => clk_in,
      clk_out => clk_out
    );
